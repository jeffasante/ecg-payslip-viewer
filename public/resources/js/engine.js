...
,
    ...
    getHeaderModalforms: () => {
        ...
        window.onclick = function(e) {
            ...
            else if  (e.target.id == 'payslip-overlay'){
                // console.log('yes')
                document.querySelector('#payslip-overlay').classList.toggle('hidden');
                document.querySelector('#payslip-overlay').classList.toggle('flex');
            }
        ...
        getPayslip: () => {
           ...
           // get calendar widget
            ...
            const calendar = document.querySelector('#widget');
